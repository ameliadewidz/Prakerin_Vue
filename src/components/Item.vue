<template>
  <el-row class="login-style">
    ...
    <br>
    <el-button round="primary" @click="getData()" >Get Data</el-button>
    <router-link to="/login" v-show = "type === 'register'" tag="p">Already have account? Sign in</router-link>
    <router-link to="/register" v-show = "type === 'login'" tag="p">Don't have account? Sign up</router-link>
  </el-row>
</template>
...
export default {
  ...
  methods: {
    ...
    getData(){
      fetch( 'https://www.pps-stie-nobel.org/api/harlem/detail/?id=2', {
      method: 'GET',
      headers: {
